package fr.codegym.task.task17.task1709;
...
public class Solution {
    ...
    public static class MakeProposal extends Thread {
        ...
        public void run() {
            ...
            while (proposal < 10) {
                System.out.println("Envoi de la proposition no. " + (thisProposal + 1));
        ...
        public void run() {
            ...
            while (thisProposal < 10) {
                if (thisProposal != proposal) {
                    System.out.println("Acceptation de la proposition no." + proposal);
