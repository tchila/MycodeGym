package fr.codegym.task.task20.task2008;

import java.io.*;

/* 
Comment sérialiser un singleton ?
*/
public class Solution implements Serializable {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        System.out.println("Vérifier ourInstance : " + singleton.getInstance());
        System.out.println("Vérifier ourInstance : " + singleton1.getInstance());
        System.out.println("=========================================================");
        System.out.println("Vérifier singleton : " + singleton);
        System.out.println("Vérifie singleton1 : " + singleton1);
    }
